...
var wasmBinaryFile;
  wasmBinaryFile = 'dicomviewer.wasm';
...
function qt_asyncify_resume_js() { let wakeUp = Module.qtAsyncifyWakeUp; if (wakeUp == undefined) return; Module.qtAsyncifyWakeUp = undefined; setTimeout(wakeUp); }
function qt_asyncify_suspend_js() { let sleepFn = (wakeUp) => { Module.qtAsyncifyWakeUp = wakeUp; }; return Asyncify.handleSleep(sleepFn); }
function qt_have_asyncify_js() { return typeof Asyncify != "undefined"; }
  ...
  function ___syscall_truncate64(path, /** @type {!BigInt} */ length) {
  try {
  ...
  try {
      ...
      // TODO HEAP64[(((pbuf)+(8))>>3)] = BigInt(?);
      // TODO HEAP64[(((pbuf)+(16))>>3)] = BigInt(?);
      return 0;
    } catch (e) {
    if (typeof FS == 'undefined' || !(e instanceof FS.ErrnoError)) throw e;
    return e.errno;
...
var asmLibraryArg = {
  ...
  "qt_have_asyncify_js": qt_have_asyncify_js,
